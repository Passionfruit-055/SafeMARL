...
parser.add_argument('-buffer', '--buffer_size', type=int, default=64, help='number of max buffer size')
...
parser.add_argument('-re_cycle', '--replace_cycle', type=int, default=300, help='replace cycle for target net')
# agent
parser.add_argument('-an', '--agent_num', type=int, default=2, help='number of agents')
parser.add_argument('-state', '--state_size', type=int, default=60, help='state size for whole system')
parser.add_argument('-action', '--action_size', type=int, default=6, help='action size for whole system')
parser.add_argument('-obs', '--obs_size', type=int, default=30, help='observation size for each agent')
parser.add_argument('-comm', '--comm_size', type=int, default=27, help='communication size for each agent')
# train
...
parser.add_argument('-ep', '--episode', type=int, default=1000, help='number of episodes to train for')
