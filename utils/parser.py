...
parser.add_argument('-seq', '--seq_len', type=int, default=200, help='sequence length for training')
...
parser.add_argument('-row', '--row', type=int, default=15, help='number of rows for map')
parser.add_argument('-col', '--col', type=int, default=15, help='number of columns for map')
